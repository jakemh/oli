    ...
    return {
        ...
        cli: function (f, a, b) {
            var c = '',
                ...
                now = new Date();
            if (a == 'outlook') {
                c = 'http://generate.addthisevent.com/?service=OUTLOOK' + b + '&reference=' + ref;
                nw = false
            }
            if (a == 'google') {
                c = 'http://generate.addthisevent.com/?service=GOOGLE' + b + '&reference=' + ref
            }
            if (a == 'yahoo') {
                c = 'http://generate.addthisevent.com/?service=YAHOO' + b + '&reference=' + ref
            }
            if (a == 'hotmail') {
                c = 'http://generate.addthisevent.com/?service=HOTMAIL' + b + '&reference=' + ref
            }
            if (a == 'ical') {
                c = 'http://generate.addthisevent.com/?service=ICAL' + b + '&reference=' + ref;
                nw = false
            }
            if (a == 'facebook') {
                c = 'http://generate.addthisevent.com/?service=FACEBOOK' + b + '&reference=' + ref
            }
            if (a == 'home') {
